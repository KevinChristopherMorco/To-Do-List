...
export const openModal = (e) => {
    ...
    const currentFutureDate = new Date().toISOString().split('T')[0]

    addClone.querySelector('#task-start-date').setAttribute('min', currentFutureDate)
    addClone.querySelector('#task-end-date').setAttribute('min', currentFutureDate)
